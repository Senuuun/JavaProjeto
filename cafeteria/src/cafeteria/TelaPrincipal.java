...
public class TelaPrincipal extends JFrame implements ActionListener {
    ...
    protected void createServices() {
        // Instanciar aqui os services que serão usados
        // Exemplo: this.clienteService = new ClienteService();
    }
    ...
    protected JMenuBar createMenuBar() {
        ...
        menuItem.addActionListener(new ActionListener() {
        	@Override
            public void actionPerformed(ActionEvent e) {
                // Instanciando a classe concreta RelatorioView que implementa a interface
                createAndShowFrameExportarRelatorio(new RelatorioView());
            }
        });
        ...
        menuItem.addActionListener(new ActionListener() {
        	@Override
        	public void actionPerformed(ActionEvent e) {
        	    // Usando a classe concreta RelatorioView que implementa RelatorioExportavelEmArquivoTexto
        	    createAndShowFrameExportarRelatorio(new RelatorioView());
        	}
        });
        submenu.add(menuItem);
